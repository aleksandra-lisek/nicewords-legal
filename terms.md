...
Contact: **contact.nicewords@gmail.com**

## 2. The Service

Nice Words is a mobile application providing curated positive affirmations, custom affirmation collections, daily task tracking, streak tracking, and related motivational content. The App offers both a free tier and an optional paid subscription ("Premium").

## 3. Eligibility

You must be at least 13 years old to use the App. For users in the EU/EEA, you must be at least 16 years old, or 13–15 with verifiable parental consent per GDPR Art. 8. By using the App, you represent that you meet the applicable age requirement.

## 4. Account Registration

To use certain features, you must create an account by signing in with an email address, Google account, or Apple ID. You are responsible for:
...
Nice Words offers optional auto-renewable subscriptions (monthly, yearly). Subscriptions unlock features such as unlimited groups, unlimited affirmations, custom badges, and an ad-free experience.

### 5.2 Billing (Apple App Store — iOS users)

Subscriptions purchased on iOS are processed by Apple through the App Store:
...
**By purchasing a subscription and receiving immediate access to Premium features, you expressly consent to the immediate performance of the service and acknowledge that you will lose your right of withdrawal once the service has been fully performed.** This is required by Article 16(m) of the EU Consumer Rights Directive.

If you have not yet used the Premium features and wish to withdraw within 14 days:
- Contact us at **contact.nicewords@gmail.com**
- Or use the model withdrawal form available at https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32011L0083 (Annex I(B))
...
- For material price increases (as defined by Apple/Google policies), your **opt-in** consent will be required to continue the subscription; without your consent, the subscription will not renew at the higher price
- Price decreases apply automatically without notice

## 6. Refunds

Because payments are processed by Apple or Google (not by us directly), refund requests must be submitted through the store where the purchase was made:

- **iOS (Apple):** https://reportaproblem.apple.com
- **Android (Google Play):** https://play.google.com/store/account/subscriptions
...
**Conformity of the service** — We ensure that the App conforms to the description we provide, is fit for the purposes for which digital services of the same type are normally used, and has the quality and functionality you can reasonably expect (Digital Content Directive 2019/770).

**Updates** — Throughout your subscription period, we will provide updates (including security updates) necessary to keep the App in conformity. You are responsible for installing updates within a reasonable time. If you do not install them, we are not responsible for any resulting non-conformity.

**Remedies for non-conformity** — If the App fails to conform, you may:
1. Request that we bring the App into conformity, unless doing so is impossible or disproportionate
2. Receive a proportionate reduction in price
3. Terminate the contract, provided the non-conformity is not minor
...
- Is unlawful, harmful, threatening, abusive, or hateful
- Infringes intellectual property or privacy rights of others
- Contains malware or is intended to disrupt the App
...
- Change these Terms with prior notice through the App
- Update, patch, or improve the App
...
**For paying subscribers:** Our aggregate liability for any claim arising from or related to the App or these Terms shall not exceed the total amount you paid us for the subscription in the **12 months preceding the event giving rise to the claim**.

**For free users:** Our aggregate liability for any claim arising from or related to the App shall not exceed **€25**.

**We are not liable for** indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data loss, or loss of goodwill, even if advised of the possibility of such damages.
...
**By us:** We may suspend or terminate your access if you materially violate these Terms. We will give you notice and an opportunity to cure where reasonably possible.

**Effect of termination:**
- Your access to the App ends immediately
- Your locally stored data on the device remains until you uninstall the App
- Your cloud-stored data (Firestore) is deleted immediately upon account deletion; **we do not maintain user-recoverable backups, so account deletion is permanent**
- Certain data may be retained where required by law (tax records: 7 years in Poland; legal claims: applicable statute of limitations)
...
**Jurisdiction:**
- For **non-consumer disputes**, the courts of Warsaw, Poland shall have exclusive jurisdiction.
- For **consumer disputes**, you may bring proceedings against us in the courts of Poland or in the courts of the EU Member State where you are domiciled. We may bring proceedings against you only in the courts of the EU Member State where you are domiciled.

**Mandatory consumer protection:** Nothing in this section deprives you of the protection afforded to you by provisions that cannot be derogated from by agreement under the law of your habitual residence (Rome I Regulation, Art. 6(2)).
...
**➤ Please include the word "COMPLAINT" in the subject line so we can prioritize it.**
...
We will acknowledge your complaint within **48 hours** and provide a substantive response within **14 days**. If we need more time, we will inform you of the reason and provide a new deadline.

If we do not respond within 14 days, your complaint is considered accepted.
...
**Entire Agreement:** These Terms, together with the Privacy Policy, constitute the entire agreement between you and us regarding the App and supersede prior agreements.

**No Waiver:** Our failure to enforce any provision does not constitute a waiver of that provision.

**Assignment:** You may not assign your rights or obligations under these Terms without our written consent. We may assign these Terms to a successor entity in connection with a merger, acquisition, or sale of assets, subject to prior notice to you and your right to terminate.
